...
RAW_SCRIPT="https://raw.githubusercontent.com/vinaheybird/phicomm-control/main/install_tools/termux_install.sh?t=$(date +%s 2>/dev/null || echo 1)"
...
echo "[*] Dang tai script cai dat moi nhat tu GitHub..."
